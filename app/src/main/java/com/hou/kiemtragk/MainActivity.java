...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtNumber,txtName,txtDuration;
    ...
    private void setUp() {
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String duration = getDuration(mediaPlayer.getDuration());
...
//
    ...
    private void setSongs() {
        listSong.add(new Song(1,"Bài Hát 1",R.raw.song));
        listSong.add(new Song(2,"Bài Hát 2",R.raw.song1));
        listSong.add(new Song(3,"Bài Hát 3",R.raw.song2));
        listSong.add(new Song(4,"Bài Hát 4",R.raw.song3));
        listSong.add(new Song(5,"Bài Hát 5",R.raw.song4));
        listSong.add(new Song(6,"Bài Hát 6",R.raw.song5));
    }
